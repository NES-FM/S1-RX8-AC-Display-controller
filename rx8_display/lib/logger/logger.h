...
#define logln( format, ... ) logger_log_formatted_string( "[ARD]" LOGGER_LOG_FORMAT( format ), ##__VA_ARGS__ )

#define log_inline_begin() logger_log_formatted_string( "[ARD]" LOGGER_LOG_FORMAT_INLINE( "" ) )
